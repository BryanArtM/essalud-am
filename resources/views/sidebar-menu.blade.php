        ...
        <div class="space-y-1">
            ...
            @if (auth()->user()->is_admin)
                ...
                <a href="{{ route('users.index') }}"
                    class="group flex items-center px-3 py-2.5 text-sm font-medium {{ request()->routeIs('users.index') ? 'text-white bg-slate-900 border-l-3 border-blue-400' : 'text-white hover:text-blue-200 hover:bg-gray-700 border-l-3 border-transparent' }} transition-all duration-200">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.reportes') }}"
                    class="group flex items-center px-3 py-2.5 text-sm font-medium {{ request()->routeIs('admin.reportes') ? 'text-white bg-slate-900 border-l-3 border-purple-400' : 'text-white hover:text-purple-200 hover:bg-gray-700 border-l-3 border-transparent' }} transition-all duration-200">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.configuracion') }}"
                    class="group flex items-center px-3 py-2.5 text-sm font-medium {{ request()->routeIs('admin.configuracion') ? 'text-white bg-slate-900 border-l-3 border-orange-400' : 'text-white hover:text-orange-200 hover:bg-gray-700 border-l-3 border-transparent' }} transition-all duration-200">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z">
                        </path>
