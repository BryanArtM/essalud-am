    ...
    <x-dialog-modal wire:model.live="confirmingPassword">
        ...
        <x-slot name="content">
            ...
            <div class="mt-4" x-data="{}"
                x-on:confirming-password.window="setTimeout(() => $el.querySelector('input').focus(), 250)">
                <x-input-password class="mt-1 block w-3/4" placeholder="{{ __('Password') }}" autocomplete="current-password"
