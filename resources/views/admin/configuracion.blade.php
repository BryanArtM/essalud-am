        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="p-6 bg-gray-50 min-h-screen">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-600 mt-1">Administre la configuración general, rendimiento y seguridad de la
                        aplicación</p>
                </div>
                        ...
                        <div class="p-6 bg-white">
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div
                                    ...
                                    <div class="text-3xl font-bold text-blue-900 mb-1">{{ \App\Models\User::count() }}
                                    </div>
                ...
                <div class="mb-8">
                    ...
                    <div class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
                        <div class="px-6 py-4 bg-white border-b border-gray-100">
                            ...
                            <p class="text-sm text-gray-500 mt-0.5">Accesos directos a las secciones principales del
                                sistema</p>
                        </div>
                        <div class="p-6 bg-white">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                <a href="{{ route('users.index') }}"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="font-semibold text-gray-900 group-hover:text-blue-900">Gestionar
                                                Usuarios
                                            </div>
                                            <div class="text-xs text-gray-500">Administración de usuarios del sistema
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <a href="{{ route('adultos.index') }}"
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <div>
                                            <div class="font-semibold text-gray-900 group-hover:text-green-900">Ver
                                                Adultos Mayores
                                            </div>
                ...
                <div class="mb-8">
                    ...
                    @if (Laravel\Fortify\Features::canManageTwoFactorAuthentication())
                        <div class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden mb-4">
                            <div class="px-6 py-4 bg-white border-b border-gray-100">
                                ...
                                <p class="text-sm text-gray-500 mt-0.5">Agregue seguridad adicional a su cuenta
                                    mediante 2FA</p>
                            </div>
                            <div class="p-6 bg-white">
                    ...
                    <div class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden mb-4">
                        <div class="px-6 py-4 bg-white border-b border-gray-100">
                            ...
                            <p class="text-sm text-gray-500 mt-0.5">Administre y cierre sesiones activas en otros
                                dispositivos</p>
                        </div>
                        <div class="p-6 bg-white">
                ...
                <div class="mb-8">
                    <div class="flex items-center mb-4">
                        ...
                        <h3 class="text-lg font-bold text-gray-800 uppercase tracking-wide">Rendimiento y Optimización
                        </h3>
                    </div>
                    ...
                    <div class="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
                        <div class="px-6 py-4 bg-white border-b border-gray-100">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500 mt-0.5">Limpie el caché para mejorar el rendimiento
                                        del sistema
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="p-6 bg-gray-50">
                            ...
                            @if (session('cache_success'))
                                <div
                                    class="mt-4 p-3 bg-green-50 border-l-4 border-green-500 rounded-r flex items-start">
