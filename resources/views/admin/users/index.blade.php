            ...
            <div class="p-6">
                ...
                <div class="bg-gray-50 rounded-lg p-4 mb-6">
                    <form method="GET" action="{{ route('users.index') }}"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Buscar por nombre o
                                email</label>
                        ...
                        <div>
                            ...
                            <select name="role"
                                ...
                                <option value="user" {{ request('role') === 'user' ? 'selected' : '' }}>Profesional
                                </option>
                            </select>
                        </div>
                            ...
                            <thead class="bg-blue-400 text-white">
                                <tr>
                                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider">
                                        Nombre</th>
                                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase tracking-wider">Email
                                    </th>
