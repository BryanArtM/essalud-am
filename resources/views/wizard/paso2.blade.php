            ...
            <div class="bg-white overflow-hidden shadow-md rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('wizard.paso2') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label>Fecha:</label>
                            <input type="date" name="visare_fecha"
                                value="{{ old('visare_fecha', $data['visare_fecha'] ?? '') }}"
                                class="w-full border rounded px-3 py-2">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label>Fecha:</label>
                            <input type="date" name="estadio_3b_5_fecha"
                                value="{{ old('estadio_3b_5_fecha', $data['estadio_3b_5_fecha'] ?? '') }}"
                                class="w-full border rounded px-3 py-2">
                        </div>
                    </div>
