    ...
    <div class="flex min-h-screen bg-gray-100">
        ...
        <aside class="w-64 bg-white shadow-lg">
            ...
            <nav class="p-4 space-y-2">
                ...
                <a href="{{ route('adultos.index') }}" class="block px-4 py-2 rounded hover:bg-gray-200">📋 Adultos Mayores</a>
                <a href="{{ route('adultos.create') }}" class="block px-4 py-2 rounded hover:bg-gray-200">➕ Nuevo Registro</a>
            </nav>
        </aside>
        ...
        <main class="flex-1 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <a href="{{ route('adultos.index') }}" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
                ...
                <a href="{{ route('adultos.create') }}" class="bg-white p-6 rounded-lg shadow hover:shadow-lg transition">
