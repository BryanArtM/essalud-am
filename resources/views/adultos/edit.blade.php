                ...
                <form action="{{ route('adultos.update', $adulto->id) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                        <div>
                            ...
                            <x-input id="dni" name="dni" type="text"
                                     value="{{ old('dni', $adulto->dni) }}"
                        ...
                        <div>
                            ...
                            <x-input id="apellidos" name="apellidos" type="text"
                                     value="{{ old('apellidos', $adulto->apellidos) }}"
                                     class="block w-full mt-1" />
                        </div>
                        ...
                        <div>
                            ...
                            <x-input id="nombres" name="nombres" type="text"
                                     value="{{ old('nombres', $adulto->nombres) }}"
                                     class="block w-full mt-1" />
                        </div>
                        ...
                        <div>
                            ...
                            <select id="sexo" name="sexo" class="block w-full mt-1 border-gray-300 rounded-md shadow-sm">
                        ...
                        <div>
                            ...
                            <x-input id="direccion" name="direccion" type="text"
                                     value="{{ old('direccion', $adulto->direccion) }}"
                                     class="block w-full mt-1" />
                        </div>
                        ...
                        <div>
                            ...
                            <x-input id="telefono" name="telefono" type="text"
                                     value="{{ old('telefono', $adulto->telefono) }}"
                                     class="block w-full mt-1" />
                        </div>
