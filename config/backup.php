...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 */
                'include' => [
                    // Comentamos el base_path() para hacer backup solo de la base de datos
                    // base_path(),
                ],
    ...
    'notifications' => [
        'notifications' => [
            ...
            // \Spatie\Backup\Notifications\Notifications\BackupWasSuccessfulNotification::class => ['mail'], // Desactivado - solo errores
            // \Spatie\Backup\Notifications\Notifications\HealthyBackupWasFoundNotification::class => ['mail'], // Desactivado - solo errores
            // \Spatie\Backup\Notifications\Notifications\CleanupWasSuccessfulNotification::class => ['mail'], // Desactivado - solo errores
        ],
